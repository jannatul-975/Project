...
// Insert booking
$stmt = $conn->prepare("INSERT INTO booking (guestId, checkInDate, checkOutDate, totalAmount, travelPurpose, paymentStatus) VALUES (?, ?, ?, ?, ?, 'Pending')");
$stmt->bind_param("issds", $guest_id, $checkin_date, $checkout_date, $totalAmount, $travelPurpose);
